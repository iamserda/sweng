...
class Company:
    ...
    def add_new_employee(self, emp:dict):

        print("Is this a salaried employee?")
        ...
        if is_salaried:
            ...
            print(f"New Salaried Employee Created:\n{new_employee}")
            self.salaried_employes.append(new_employee)
            print(f"Added new salaried employee: {new_employee.first_name}, {new_employee.last_name} to the company's salaried employee list.")
        else:
